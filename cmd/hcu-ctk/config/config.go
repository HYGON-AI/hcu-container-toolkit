...
import (
	"errors"
	"fmt"
	createdefault "hcu-container-toolkit/cmd/hcu-ctk/config/create-default"
	"hcu-container-toolkit/cmd/hcu-ctk/config/flags"
...
func (m command) build() *cli.Command {
	...
	c := cli.Command{
		Name:  "config",
		Usage: "Interact with the Hygon HCU Container Toolkit configuration",
